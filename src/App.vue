...
<section id ="app">
    ...
    <main class="wrapper ai-window">
        ...
        <div v-if="answers.length == 0 && online == true">
            <h1 class="title mdc-typography--headline">
                ...
                <p><span>{{config.locale.strings.welcomeTitle1}}</span><span class="title2">{{config.locale.strings.welcomeTitle2}}</span></p>
    ...
    <div class="query">
        <div class="wrapper" v-if="micro == false">
            <i class="material-icons iicon" @click="mute(true)" v-if="muted == false">volume_up</i>
            <i class="material-icons iicon" @click="mute(false)" v-else>volume_off</i>
            ...
            <i class="material-icons iicon t2s" @click="microphone(true)">mic</i>
        </div>
